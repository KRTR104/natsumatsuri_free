...
public class IkayakiGameManager : MonoBehaviour
{
    public static IkayakiGameManager Instance { get; private set; }
    ...
    public void OnIkayakiFinished(int addScore, string message, bool success)
    {
        if (!playing) return;
